import { Grid3X3, Shirt, Sparkles, ShoppingBag, UserRound } from "lucide-react";
import { NavLink } from "react-router-dom";
import { cn } from "@/lib/utils";

const navItems = [
  { to: "/app/audit", label: "Audit", Icon: Grid3X3 },
  { to: "/app/wardrobe", label: "Wardrobe", Icon: Shirt },
  { to: "/app/looks", label: "Looks", Icon: Sparkles },
  { to: "/app/buy", label: "Buy", Icon: ShoppingBag },
...
export function BottomNav() {
  return (
    <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/85">
      <div className="mx-auto grid h-16 max-w-2xl grid-cols-5 px-2 pb-[env(safe-area-inset-bottom)]">
